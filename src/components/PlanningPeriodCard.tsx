...
export const PlanningPeriodCard = ({
  ...
  return (
    <ActionCard title="Timeline Window" icon={<Clock className="w-4 h-4" />}>
      {/* Preset Selector */}
      <div className="inline-flex items-center bg-slate-800/90 border border-slate-700/60 rounded-xl px-3 py-1.5 text-xs">
        ...
        <select
          ...
          className="bg-transparent font-semibold text-indigo-300 focus:outline-none cursor-pointer pr-1 text-xs"
        >
